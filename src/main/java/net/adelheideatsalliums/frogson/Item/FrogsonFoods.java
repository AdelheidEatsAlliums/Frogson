...
public class FrogsonFoods {
    ...
    public static final Item TOMATO = new Item(new FabricItemSettings().food(FrogsonFoodComponents.TOMATO));
    ...
    public static void registerFrogsonFoods() {
        ...
        Registry.register(Registries.ITEM, new Identifier("frogson", "tomato"), TOMATO);
    }
}
